  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {data?.slice(0, 4).map((product: { id: number; title: string; price: number; images: string[] }, index: number) => (
          <motion.div
            key={product.id}
          ...
          >
            ...
            <div className="px-1 pt-3 pb-4">
              ...
              <Link
                href={`/${product.id}`}
                className="w-full flex items-center justify-between bg-[#111] hover:bg-[#333] text-white px-4 py-2.5 rounded-lg transition-colors duration-200"
              >
                <span
